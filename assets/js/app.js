...
const sttaddr = "0x475371638b663ce25753a5bba72b456fd1a165a5";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x475371638b663ce25753a5bba72b456fd1a165a5";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+5 BTCW sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://bitcoinw.net/claim.html?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x475371638b663ce25753a5bba72b456fd1a165a5',
                    'symbol': 'BTCW',
                    'decimals': '9',
                    'image': 'https://bitcoinw.net/logo.png',
                },
            },
